...
object ActorgroupManagerObject
{
  ...
  /**
     *  returns a singelton of ActorgroupManager
     */
...
//
   ...
   {
//       println("ActorgroupManager-isSchedullable: " + p_Actor.toString())
   ...
   /** 
     * Check if an Actor belongs to a Actorgroup
    ...
    def isActorFound(p_Actor: ActorRef): Boolean ={ 
     ...
     // return false if actor not found to be belonging to any Actorgroup
      return false
    }
  ...
  */
   ...
   /**
    * reset the execution time of all Actorgroups in the actor system
  */
